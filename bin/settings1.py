...
with open('../resources/descriptions/he.txt', encoding='utf-8') as f, open('../resources/descriptions/apfsds.txt', encoding='utf-8') as f2, open(
        '../resources/descriptions/heat.txt', encoding='utf-8') as f3:
